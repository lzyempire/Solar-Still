...
SolarWater <- read.csv(file = "Blackbody Solar Still Water Production.csv", header = FALSE, stringsAsFactors = FALSE)
...
setwd("D:/R/Solar Still")
library(lubridate)
SolarEnv_Day <- read.csv(file = "CR1000_BSRN1000_Day200814.csv", skip = 1, stringsAsFactors = FALSE)
...
write.csv(SolarData_Day, file = "Blackbody Solar Still Daily Water Production.csv")
