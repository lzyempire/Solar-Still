...
SolarWater <- read.csv(file = "Solar Still Water Production.csv", header = FALSE, stringsAsFactors = FALSE)
...
write.csv(SolarData_Day, file = "Solar Still Daily Water Production.csv")
